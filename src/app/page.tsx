        ...
        <nav className="fixed top-0 w-full z-50 bg-black/60 backdrop-blur-xl border-b border-zinc-800/50">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-10 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">
              ...
              <Link
                href="/login"
                className="bg-white text-black px-6 py-3 rounded-full hover:bg-amber-500 transition-all font-black uppercase text-[10px] tracking-widest"
              >
                Entrar
              </Link>
            </div>
      ...
      <section className="relative pt-48 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/cadastrar" className="w-full sm:w-auto bg-amber-500 text-black font-black px-12 py-5 rounded-2xl uppercase text-xs flex items-center justify-center gap-3 hover:scale-105 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-900/30 border border-zinc-800 p-8 rounded-3xl hover:border-amber-500/30 transition-all">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Crie, edite e organize seu catálogo. Defina nome, preço e o
                tempo exato de cada execução para alimentar nossa inteligência
                de agenda.
              </p>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-800 p-8 rounded-3xl hover:border-amber-500/30 transition-all">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Cadastre barbeiros com acessos individuais e vincule serviços
                específicos a cada profissional de forma dinâmica.
              </p>
            </div>
            ...
            <div className="bg-zinc-900/30 border border-zinc-800 p-8 rounded-3xl hover:border-amber-500/30 transition-all">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Bloqueie horários para a equipe toda em feriados ou defina
                períodos de folga por profissional. A agenda trava na hora.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
              ...
              <div className="bg-black rounded-2xl p-6 border border-zinc-800">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex gap-4">
                    <div className="h-10 w-32 bg-zinc-900 rounded-lg border border-zinc-800 flex items-center px-3 text-[10px] font-bold text-zinc-500 uppercase">
                      <FiFilter className="mr-2" /> 01/01 - 31/01
                    </div>
                    <div className="h-10 w-24 bg-amber-500/10 rounded-lg border border-amber-500/20 flex items-center px-3 text-[10px] font-bold text-amber-500 uppercase italic">
                      Toda Equipe
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="h-8 w-full bg-zinc-900/30 rounded flex items-center justify-between px-4 text-[9px] font-bold text-zinc-400 uppercase">
          ...
          <div className="flex-1 order-1 md:order-2">
            ...
            <p className="text-zinc-400 leading-relaxed mb-8">
              O coração do seu negócio alimentado por um **filtro inteligente**.
              Donos visualizam o faturamento global e a performance de cada
              cadeira. Barbeiros acessam apenas sua própria produtividade.
            </p>
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-sm font-bold uppercase tracking-wider text-zinc-300">
                <FiActivity className="text-amber-500" /> Status em tempo real
                (Pendente/Finalizado/Faltou)
              </li>
              <li className="flex items-center gap-3 text-sm font-bold uppercase tracking-wider text-zinc-300">
                <FiTrendingUp className="text-amber-500" /> Métricas de ocupação
                total e individual
              </li>
              <li className="flex items-center gap-3 text-sm font-bold uppercase tracking-wider text-zinc-300">
                <FiSearch className="text-amber-500" /> Gestão de agendamentos
      ...
      <section id="agendamento" className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-zinc-500 text-lg leading-relaxed">
            Nada de horários encavalados. Nosso sistema calcula o tempo do
            serviço contra o espaço livre. Se não cabe, ele não mostra. Simples
            assim.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-7xl mx-auto">
          <div className="bg-zinc-900/20 border border-zinc-800 p-10 rounded-3xl">
            ...
            <h4 className="text-2xl font-black uppercase mb-4 italic">
              Cálculo de Slot Real
            </h4>
            <p className="text-zinc-500 text-sm leading-relaxed">
              Exemplo: Um barbeiro tem 15min livres. O cliente escolhe um
              serviço de 30min. O sistema identifica a falta de espaço e remove
              esse horário das opções, garantindo que o barbeiro nunca atrase.
            </p>
          </div>
          <div className="bg-zinc-900/20 border border-zinc-800 p-10 rounded-3xl">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed">
              O cliente acessa, digita o telefone e vê todo o seu histórico. Ele
              mesmo pode editar ou cancelar o agendamento, liberando sua equipe
              para o que importa: o corte.
            </p>
          </div>
        </div>
      </section>
